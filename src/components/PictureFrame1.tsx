...
export function PictureFrame1(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/pictureFrame1.gltf') as GLTFResult
  return (
...
useGLTF.preload('/pictureFrame1.gltf')
